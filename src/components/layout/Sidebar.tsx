...
import {
  BookOpen, LayoutDashboard, BarChart3, Shield, Settings,
  LogOut, GraduationCap, ChevronLeft, ChevronRight, HelpCircle,
} from 'lucide-react';
        ...
        <div className="flex items-center gap-3 px-2 py-2">
          ...
          {!collapsed && (
            <div className="flex-1 min-w-0">
              ...
              <p className="text-xs text-text-muted truncate">{user?.role || 'ADMIN'}</p>
            </div>
          )}
          {!collapsed && (
