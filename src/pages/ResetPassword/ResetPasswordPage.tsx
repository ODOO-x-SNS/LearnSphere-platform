...
export function ResetPasswordPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const msg = err.response?.data?.message || 'Reset failed. The link may have expired or already been used.';
      setError(msg);
      toast('error', msg);
    } finally {
      setLoading(false);
      ...
      <div className="min-h-screen flex items-center justify-center bg-white p-8">
        <div className="text-center max-w-md">
          ...
          <p className="text-sm text-text-muted mb-6">
            This password reset link is invalid. Please go back to the login page and request a new one.
          </p>
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-white p-8">
      <div className="w-full max-w-[420px]">
        ...
        {!success ? (
          <>
            <h2 className="text-2xl font-bold text-text-primary tracking-tight mb-1.5">Set a new password</h2>
          ...
          <div className="text-center py-4">
            ...
            <h2 className="text-xl font-bold text-text-primary mb-2">Password reset successful</h2>
            <p className="text-sm text-text-muted mb-6">
